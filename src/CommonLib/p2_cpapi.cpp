...
//         fMessage.attrs = malloc(totalAttrSize);
        ...
        for (uint32 attr_i = 0; attr_i < fAttrNum; attr_i++)
        {
            ...
            {
			case dt_int8:
				entry->data.i8 = ntohs(entry->data.i8);
				break;
            case dt_int16:
            ...
            case dt_string:
                ...
                break;
            default:
                log_debug(5, _T("Message::Message no such data type!\n"));
                break;
            }
    ...
    else
    {
        ...
        HASH_ITER(hh, fAttrs, entry, tmp)
        {
            ...
            case dt_string:
                ...
                break;
            default:
                log_debug(5, _T("Message::CreateMessage no such data type!\n"));
                break;
            }
            pDest += attrSize;
        }
...
void Message::set(attr_code attrCode, attr_datatype dataType, const void *value, attr_flags flags/* = af_none*/, uint32 size/* = 0*/)
{
    ...
    {
	case dt_int8:
		entry = CreateMessageAttr(ATTR_HEADER_SIZE + 1);
		entry->data.i8 = *((uint8*)value);
		break;
    case dt_int16:
    ...
    case dt_string:
        ...
        break;
    default:
        log_debug(5, _T("Message::set no such data type!\n"));
        break;
    }
    entry->code = attrCode;
...
void* Message::get(attr_code attrCode, attr_datatype dataType, void *buffer/* = nullptr*/, uint32 bufferSize/* = 0*/) const
{
    ...
    case dt_string:
        ...
        break;
    default:
        log_debug(5, _T("Message::get no such data type!\n"));
        break;
    }
    return nullptr;
}
